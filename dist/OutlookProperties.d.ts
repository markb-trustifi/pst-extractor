export declare enum OutlookProperties {
    ...
    PidLidCommonStart = 34070,
    PidLidCommonEnd = 34071,
    ...
    PidLidTimeZoneDescription = 33332,
    PidLidClipStart = 33333,
    PidLidClipEnd = 33334,
    ...
    PidLidAppointmentUnsendableRecipients = 33373,
    PidLidIsSilent = 4,
    PidLidRequiredAttendees = 6,
    PidLidOptionalAttendees = 7,
    PidLidResourceAttendees = 8,
