                ...
                try {
                    ...
                    if (childNode !== undefined) {
                        ...
                        return new CollectionAsyncProvider_1.CollectionAsyncProvider(rows.length, (index) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            return new PSTRecipient_class_1.PSTRecipient(this.pstFile, this._node, this._subNode, propertyFinder);
                        }));
                    }
                ...
                try {
                    ...
                    if (childNode !== undefined) {
                        ...
                        return new CollectionAsyncProvider_1.CollectionAsyncProvider(rows.length, (index) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            const pc2 = yield (0, PropertyContextUtil_1.getPropertyContext)(heap2, this.pstFile.resolver);
                            const propertyFinder2 = (0, PAUtil_1.createPropertyFinder)(yield pc2.list());
                            return new PSTAttachment_class_1.PSTAttachment(this.pstFile, this._node, child2, propertyFinder2);
                        }));
                    }
                    return new CollectionAsyncProvider_1.CollectionAsyncProvider(0, index => {
