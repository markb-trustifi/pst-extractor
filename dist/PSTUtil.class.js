...
class PSTUtil {
     ...
     * @memberof PSTUtil
     */
    static createAppropriatePSTMessageObject(theFile, node, subNode, resolver) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const propertyFinder = (0, PAUtil_1.createPropertyFinder)(propList);
            ...
            switch (messageClass) {
                ...
                case 'IPM.Note.Agenda':
                    // email message
                    const msg = new PSTMessage_class_1.PSTMessage(theFile, node, subNode, propertyFinder);
                    // Log.debug1(msg.body);
                ...
                case 'IPM.Schedule.Meeting.Resp.Neg':
                    ...
                    const apt = new PSTAppointment_class_1.PSTAppointment(theFile, node, subNode, propertyFinder);
                    // Log.debug1(JSON.stringify(msg, null, 2));
                    return apt;
                case 'IPM.Contact':
                    // contact
                    const contact = new PSTContact_class_1.PSTContact(theFile, node, subNode, propertyFinder);
                    // Log.debug1(JSON.stringify(msg, null, 2));
                    return contact;
                case 'IPM.Task':
                    // task
                    const task = new PSTTask_class_1.PSTTask(theFile, node, subNode, propertyFinder);
                    // Log.debug1(JSON.stringify(msg, null, 2));
                    return task;
                case 'IPM.Activity':
                    // journal entry
                    const activity = new PSTActivity_class_1.PSTActivity(theFile, node, subNode, propertyFinder);
                    // Log.debug1(JSON.stringify(msg, null, 2));
                    return activity;
                case 'IPM.Post.Rss':
                    // debugger;
                    // Rss Feed
                    const rss = new PSTMessage_class_1.PSTMessage(theFile, node, subNode, propertyFinder);
                    // Log.debug1(JSON.stringify(msg, null, 2));
                    return rss;
                case 'IPM.DistList':
                    // debugger;
                    // Distribution list
                    const dl = new PSTMessage_class_1.PSTMessage(theFile, node, subNode, propertyFinder);
                    // Log.debug1(JSON.stringify(msg, null, 2));
                    return dl;
                ...
                case 'IPM.Note.Rules.OofTemplate.Microsoft':
                    // debugger;
                    // Out of Office rule
                    const oof = new PSTMessage_class_1.PSTMessage(theFile, node, subNode, propertyFinder);
                    // Log.debug1(JSON.stringify(msg, null, 2));
                    return oof;
                case 'IPM.Schedule.Meeting.Request':
                    // Meeting request
                    const meetReq = new PSTMessage_class_1.PSTMessage(theFile, node, subNode, propertyFinder);
                    // Log.debug1(JSON.stringify(msg, null, 2));
                    return meetReq;
                case 'REPORT.IPM.Note.NDR':
                    // Receipt of non-delivery
                    const ndr = new PSTMessage_class_1.PSTMessage(theFile, node, subNode, propertyFinder);
                    // Log.debug1(JSON.stringify(msg, null, 2));
                    return ndr;
                case 'IPM.StickyNote':
                    // Sticky note
                    const sticky = new PSTMessage_class_1.PSTMessage(theFile, node, subNode, propertyFinder);
                    // Log.debug1(JSON.stringify(msg, null, 2));
                    return sticky;
                case 'REPORT.IPM.Note.IPNRN':
                    ...
                    return new PSTMessage_class_1.PSTMessage(theFile, node, subNode, propertyFinder);
