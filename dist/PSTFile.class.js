...
class PSTFile {
    ...
    getMessageStore() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new PSTMessageStore_class_1.PSTMessageStore(this, node, node.getSubNode(), propertyFinder);
        });
    }
    /**
     *
    ...
    getFolderOf(node) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const pc = yield (0, PropertyContextUtil_1.getPropertyContext)(heap, this._resolver);
            const propertyFinder = (0, PAUtil_1.createPropertyFinder)(yield pc.list());
            const output = new PSTFolder_class_1.PSTFolder(this, node, node.getSubNode(), propertyFinder);
            return output;
        });
    }
    /**
    ...
    getItemOf(node, subNode) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield PSTUtil_class_1.PSTUtil.createAppropriatePSTMessageObject(this, node, subNode, this._resolver);
        });
    }
    /**
