...
enum ElectronicAddressProperties {
  EMAIL_1 = 0x00000000,
  EMAIL_2 = 0x00000001,
  EMAIL_3 = 0x00000002,
...
enum EntryIDType {
  ...
  */
  ...
  ADDRESS_BOOK_RECIPIENT = '\xDC\xA7\x40\xC8\xC0\x42\x10\x1A\xB4\xB9\x08\x00\x2B\x2F\xE1\x82',
  // Contact address or personal distribution list recipient.,
  CA_OR_PDL_RECIPIENT = '\xFE\x42\xAA\x0A\x18\xC7\x1A\x10\xE8\x85\x0B\x65\x1C\x24\x00\x00',
  // This is also used for the Store Object EntryID structure.,
  NNTP_NEWSGROUP_FOLDER = '\x38\xA1\xBB\x10\x05\xE5\x10\x1A\xA1\xBB\x08\x00\x2B\x2A\x56\xC2',
  ONE_OFF_RECIPIENT = '\x81\x2B\x1F\xA4\xBE\xA3\x10\x19\x9D\x6E\x00\xDD\x01\x0F\x54\x02',
  PUBLIC_MESSAGE_STORE = '\x1A\x44\x73\x90\xAA\x66\x11\xCD\x9B\xC8\x00\xAA\x00\x2F\xC4\x5A',
  // [MS-OXOCNTC] WrappedEntryId Structure.,
  WRAPPED = '\xC0\x91\xAD\xD3\x51\x9D\xCF\x11\xA4\xA9\x00\xAA\x00\x47\xFA\xA4'
}
...
enum RecurPatternTypeSpecificWeekday {
  /*
  See [MS-OXOCAL] for details.,
  */
  SATURDAY = 0b10,
